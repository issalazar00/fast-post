    ...
    <form class="">
      <div class="modal-body">
        <div class="form-group col-12">
          ...
          <input type="text" class="form-control truncate" id="description" placeholder="Descripción del gasto a realizar"
        ...
        <div class="form-group col-12">
          ...
          <input type="date" class="form-control" id="date" v-model="formExpense.date" />
        ...
        <div class="form-row col-12">
          <div class="form-group col-11">
            ...
            <v-select :options="expenseTypeList" label="description" aria-logname="{}"
              :reduce="(expenseType) => expenseType.description" v-model="formExpense.type_output"
          ...
          <div class="form-group col-1">
            <button type="button" class="btn btn-success border-success mt-4" v-if="!show_type_output"
              @click="show_type_output = true">
              <i class="bi bi-plus-circle"></i>
            </button>
            <button type="button" class="btn btn-danger border-danger mt-4" v-if="show_type_output"
        ...
        <div class="form-group col-12">
          <create-edit-type-expense class="border p-1 bg-light" v-if="show_type_output"
            @list-type-expenses="listTypeExpenses(), (show_type_output = false)" />
        </div>
        <div class="form-group col-12">
          <label for="price">Precio: <b>{{ formExpense.price | currency }} </b></label>
          <input type="number" step="any" class="form-control" id="price" placeholder="$" v-model="formExpense.price" />
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" @click="editar ? editExpense() : createExpense()">
          Guardar
        </button>
      </div>
    </form>
