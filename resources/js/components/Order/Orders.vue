<template>
  <div class="w-100 position-relative">
    <div class="position-absolute modal-download d-flex" v-if="is_download_pdf">
      <moon-loader
        class="m-auto"
        :loading="true"
        :color="'#FFFFFF'"
          ...
          <table class="table table-sm table-bordered table-responsive-sm">
            <thead>
              <tr>
                ...
                <th v-if="$root.validatePermission('order.delete')">
                  Eliminar
                </th>
              </tr>
            </thead>
