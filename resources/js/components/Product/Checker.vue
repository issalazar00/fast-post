<template>
    <div
        class="bg-primary w-100 text-center text-white vh-100"
        ...
        <div class="p-5 w-100">
            ...
            <div class="form-group w-100">
                ...
                <input
                    id="filter"
                    type="text"
                    class="form-control form-control-lg p-5"
                ...
                <div class=" text-center mt-2">
                    <span
                        v-if="not_found"
                        class=" text-center text-danger p-4 h4 bg-white w-50"
                    >
...
export default {
    ...
    methods: {
        searchProduct() {
            ...
            var url =
                "api/products/search-product?product=" + me.filters.product;
            axios
